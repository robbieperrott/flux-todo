...
export default function TaskCard(props: TaskCardProps) {
  ...
  return (
    <Card
      className={`bg-foreground hover:bg-secondary-foreground py-4 px-6 text-background border-none ${task.pending ? "pointer-events-none bg-muted-foreground" : ""}`}
      ...
      <CardContent className="flex px-0 justify-between items-center">
        <div className="flex items-center gap-4 overflow-hidden">
          <Checkbox
            ...
            className={
              "bg-background data-[state=checked]:bg-inherit border-none"
            }
